...
// внимательно если картинки через <picture>
const sliderPictures = document.querySelectorAll('.slider-line>picture');
...
function updateButtons() {
    ...
    btnNext.disabled = index === picturesLength - 1 ? true : false;
}
